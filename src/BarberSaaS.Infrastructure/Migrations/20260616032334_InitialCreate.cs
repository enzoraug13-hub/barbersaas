        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointsPerReal = table.Column<decimal>(type: "decimal(10,4)", nullable: false),
                    RedemptionRate = table.Column<decimal>(type: "decimal(10,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    RecipientPhone = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaxBarbers = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    MaxServices = table.Column<int>(type: "INTEGER", nullable: true),
                    MaxProducts = table.Column<int>(type: "INTEGER", nullable: true),
                    Features = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: false, defaultValue: "{}"),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlockReason = table.Column<string>(type: "TEXT", maxLength: 300, nullable: true),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    ShowInPublicPage = table.Column<bool>(type: "INTEGER", nullable: false),
                    DisplayOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<byte>(type: "INTEGER", nullable: false),
                    BillingCycle = table.Column<byte>(type: "INTEGER", nullable: false),
                    CurrentPeriodStart = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    CurrentPeriodEnd = table.Column<DateOnly>(type: "TEXT", nullable: false),
                    ...
                    ExternalCustomerId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ExternalSubId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryColor = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false, defaultValue: "#1a1a1a"),
                    SecondaryColor = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false, defaultValue: "#c9a84c"),
                    AccentColor = table.Column<string>(type: "TEXT", maxLength: 10, nullable: false, defaultValue: "#ffffff"),
                    ...
                    RequireConfirmation = table.Column<bool>(type: "INTEGER", nullable: false),
                    PublicSlug = table.Column<string>(type: "TEXT", maxLength: 100, nullable: false),
                    SendConfirmationSms = table.Column<bool>(type: "INTEGER", nullable: false),
                    SendReminderSms = table.Column<bool>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailVerifyToken = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProductSaleItems_ProductSales_SaleId",
                        column: x => x.SaleId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashbackBalance = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoyaltyWallets_Clients_ClientId",
                        column: x => x.ClientId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    CommissionType = table.Column<byte>(type: "INTEGER", nullable: false),
                    CommissionValue = table.Column<decimal>(type: "decimal(10,2)", nullable: false),
                    GoogleCalendarId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    GoogleCalendarColor = table.Column<string>(type: "TEXT", maxLength: 30, nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    ShowInPublicPage = table.Column<bool>(type: "INTEGER", nullable: false),
                    DisplayOrder = table.Column<int>(type: "INTEGER", nullable: false),
                    TenantId = table.Column<Guid>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LoyaltyTransactions_LoyaltyWallets_WalletId",
                        column: x => x.WalletId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InternalNotes = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
                    ...
                    PaidAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    PaymentMethod = table.Column<byte>(type: "INTEGER", nullable: true),
                    GoogleEventId = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    GoogleSyncedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    GoogleSyncError = table.Column<string>(type: "TEXT", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_DaysOff_Barbers_BarberId",
                        column: x => x.BarberId,
                        principalTable: "Barbers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<byte>(type: "INTEGER", nullable: false),
                    AppointmentId = table.Column<Guid>(type: "TEXT", nullable: true),
                    BarberId = table.Column<Guid>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_FinancialTransactions_Barbers_BarberId",
                        column: x => x.BarberId,
                        principalTable: "Barbers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_BarberId",
                table: "FinancialTransactions",
                column: "BarberId");

            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_TenantId_TransactionDate",
                table: "FinancialTransactions",
                columns: new[] { "TenantId", "TransactionDate" });

            migrationBuilder.CreateIndex(
                name: "IX_FinancialTransactions_TenantId_Type",
                table: "FinancialTransactions",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoyaltyWallets_ClientId",
