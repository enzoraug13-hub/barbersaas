        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinOrderValue = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentAmount = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PointsPerReal = table.Column<decimal>(type: "numeric(10,4)", nullable: false),
                    RedemptionRate = table.Column<decimal>(type: "numeric(10,4)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ContributedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WalletBalance = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageUrl = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ShowInPublicPage = table.Column<bool>(type: "boolean", nullable: false),
                    DisplayOrder = table.Column<int>(type: "integer", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Status = table.Column<byte>(type: "smallint", nullable: false),
                    BillingCycle = table.Column<byte>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryColor = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, defaultValue: "#1a1a1a"),
                    SecondaryColor = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, defaultValue: "#c9a84c"),
                    AccentColor = table.Column<string>(type: "character varying(10)", maxLength: 10, nullable: false, defaultValue: "#ffffff"),
                    ...
                    CustomPriceEnabled = table.Column<bool>(type: "boolean", nullable: false),
                    PublicSlug = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    SendConfirmationSms = table.Column<bool>(type: "boolean", nullable: false),
                    SendReminderSms = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EmailVerifyToken = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CashbackBalance = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Phone = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    CommissionType = table.Column<byte>(type: "smallint", nullable: false),
                    CommissionValue = table.Column<decimal>(type: "numeric(10,2)", nullable: false),
                    GoogleCalendarId = table.Column<string>(type: "character varying(200)", maxLength: 200, nullable: true),
                    GoogleCalendarColor = table.Column<string>(type: "character varying(30)", maxLength: 30, nullable: true),
                    IsActive = table.Column<bool>(type: "boolean", nullable: false),
                    ShowInPublicPage = table.Column<bool>(type: "boolean", nullable: false),
                    DisplayOrder = table.Column<int>(type: "integer", nullable: false),
                    TenantId = table.Column<Guid>(type: "uuid", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GoogleSyncedAt = table.Column<DateTime>(type: "timestamp without time zone", nullable: true),
                    GoogleSyncError = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: true),
